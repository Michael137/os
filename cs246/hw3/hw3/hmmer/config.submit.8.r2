...
arguments = out/cache_assoc_8.r2.out config-base-8.r2 0 /usr/local/benchmarks/hmmer_O3 /usr/local/benchmarks/inputs/nph3.hmm /usr/local/benchmarks/inputs/swiss41

# no standard input needed this time
# input = measure.in

# files in which to save standard output and standard error
output = measure-log-8.r2.out
error = measure-log-8.r2.err

# file for condor’s statistics about the job’s execution
log = measure-log-8.r2.log
...
transfer_input_files = ../obj-intel64/hw3.so,out,config-base-8.r2
