...
do
	...
	sed -i "s|ARGUMENTS|out/cache_assoc_${i}.out $CONFIG_NAME /usr/local/benchmarks/hmmer_O3 /usr/local/benchmarks/inputs/nph3.hmm /usr/local/benchmarks/inputs/swiss41|g" $SUBMIT_NAME
