...
# rw timing
./benchmark.sh ipc/ipc-static "" pipe 2proc rw_time.d rw_time.out 10
./benchmark.sh ipc/ipc-static "" local 2proc rw_time.d rw_time.out 10
./benchmark.sh ipc/ipc-static "-s" local 2proc rw_time.d rw_time.out 10
